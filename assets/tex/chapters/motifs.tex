...
Say that a transcription factor \textvar{X} regulates another transcription factor \textvar{Y}, and consider two cells. In both cells, \textvar{X} activates the transcription of \textvar{Y}, but in the second cell, \textvar{Y} also negatively autoregulates; see \autoref{fig:two_cells} for an illustration.\\
