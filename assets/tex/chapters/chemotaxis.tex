...
For more technical details and a specification of the complete model of \textit{E.~coli} chemotaxis using BioNetGen's rule-based modeling, please follow our tutorial online.\tutorial[chemotaxis/tutorial_adaptation]
