...
\centering
\mySfFamily
\includegraphics[width = 0.63\textwidth]{../images/chemotaxis_tutorial4_ssa_vscode.png}
...
\centering
\mySfFamily
\includegraphics[width = 0.5\textwidth]{../images/chemotaxis_tutorial5_vscode.png}\\[3ex]
\includegraphics[width = 0.5\textwidth]{../images/chemotaxis_tutorial6_vscode.png}\\[3ex]
\includegraphics[width = 0.5\textwidth]{../images/chemotaxis_tutorial7_vscode.png}
...
\centering
\mySfFamily
\includegraphics[width = 0.65\textwidth]{../images/chemotaxis_tutorial_oneadd1e4_vscode.png}\\[2ex]
\includegraphics[width = 0.65\textwidth]{../images/chemotaxis_tutorial_oneadd1e6_vscode.png}\\[2ex]
\includegraphics[width = 0.65\textwidth]{../images/chemotaxis_tutorial_oneadd1e8_vscode.png}
\caption{Molecular concentrations over time (in seconds) in a chemotaxis simulation for a variety of initial attractant ligand particle numbers: 10,000 (first panel), 1,000,000 (second panel), and 100,000,000 (third panel). initial attractant ligand particles. Phosphorylated CheY, our metric for tumbling frequency, is shown in orange.}
...
\caption{Plots of molecular concentrations over time (in seconds) when the concentration of ligand grows exponentially with $\textvar{l}_\text{0} = \text{1000}$ and $\textvar{k} = \text{0.1}$. The concentration of bound ligand (blue) quickly hits saturation, which causes a minimum in phosphorylated CheY (and therefore a low tumbling frequency). In response, the cell increases the methylation of receptors, which increases the concentration of phosphorylated CheY (orange) back to equilibrium.}
