...
\end{tabular}
\caption{Molecular concentrations over time (in seconds) in a chemotaxis simulation for a variety of initial attractant ligand particle numbers: 10,000 (top left), 1,000,000 (top right), and 100,000,000 (bottom). Phosphorylated CheY, whose concentration is a proxy for tumbling frequency, is shown in orange.}
