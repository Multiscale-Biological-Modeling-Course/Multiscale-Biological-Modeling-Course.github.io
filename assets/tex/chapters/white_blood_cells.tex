...
Even if we are able to build a neural network with a low mean RMSD for the training set, the neural network may perform horribly on the test set, which is called ``overfitting'' and offers yet another instance of the curse of dimensionality.
