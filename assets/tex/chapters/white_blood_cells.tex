...
%We will soon apply it to reduce the dimensions of our shape space; first, we make a brief aside to discuss a different biological problem in which the application of PCA has provided amazing insights.
%
%\FloatBarrier
%\phantomsection
...
\textbf{\textit{I.~setosa}} & 50 & 0 & 0 \\
\textbf{\textit{I.~versicolor}} & 0 & 47 & 3 \\
\textbf{\textit{I.~virginica}} & 0 & 4 & 46
\end{tabular}
...
\textbf{Monocyte} & 21 & 0 & 0 \\
\textbf{Lymphocyte} & 33 & 0 & 0
\end{tabular}
...
\textbf{Monocyte} & 2 & 17 & 2 \\
\textbf{Lymphocyte} & 6 & 1 & 26
\end{tabular}
...
\textbf{\textit{I.~virginica}} & 46 & 4 \\
\textbf{\textit{I.~setosa} and \textit{I.~versicolor}} & 3 & 47 \\
\end{tabular}
...
Now that we understand more about how to quantify the performance of a classifier, we are ready to apply k-NN to our WBC shape space --- post-PCA of course! --- and assess its performance.\tutorial[white_blood_cells/tutorial_image_classification]
...
\textbf{Monocyte} & 14 & 6 & 1 \\
 \textbf{Lymphocyte} & 5 & 2 & 26
\end{tabular}
...
\textbf{Monocyte} & 0 & 0 & 21 \\
\textbf{Lymphocyte} & 0 & 0 & 33
\end{tabular}
...
\textbf{Monocyte} & 16 & 5 & 0 \\
\textbf{Lymphocyte} & 20 & 0 & 13
\end{tabular}
