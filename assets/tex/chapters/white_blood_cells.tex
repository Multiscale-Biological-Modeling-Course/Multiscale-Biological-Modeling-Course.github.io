...
\caption{(Top) The projection of each WBC shape vector onto a three-dimensional PCA hyperplane produces the above three-dimensional space. (Bottom) The same reduced dimension shape space, with granulocytes subdivided into basophils, eosinophils, and neutrophils.}
