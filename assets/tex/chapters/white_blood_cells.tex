...
\autoref{fig:cellorg_pca_graph} shows the shape space of WBC images, reduced to three dimensions by PCA, in which each image is represented by a point that is color-coded according to its cell family.\tutorial[https://biologicalmodeling.org/white_blood_cells/tutorial_shape_space]\\
