...
\centering
\mySfFamily
\includegraphics[width = 0.7\textwidth]{../images/RGB_color_chart.png}
...
Classifying images of WBCs according to their family is a specific instance of a ubiquitous problem in data science, in which we wish to classify each object in a given dataset into one of \textvar{k} classes.
