...
This simplification allows us to compute the classifier statistics with respect to \textit{Iris virginica}: recall is $46/(46+4) = 92\%$; specificity is $47/(3+47) = 94\%$; and precision is $46/(46+3) = 93.9\%$.\\

\begin{qbox}[%
Compute the recall, specificity, and precision using each of the other two iris species as the positive case and the confusion matrix in \autoref{fig:iris_confusion_matrix}.
]\end{qbox}
