...
\begin{exercise}[
Apply the same pipeline as the one used to produce \autoref{fig:wbc_cellorganizer} on a dataset on a dataset containing higher resolution WBC images.
]\end{exercise}
