...
\end{tabular}
\caption{An animation of the Gray-Scott model for \textvar{f} = 0.034 and \textvar{k} = 0.100, in which a single cluster of \textvar{B} particles expands outward into clear stripes of varying \textvar{B} concentrations.}
...
\end{tabular}
\caption{An expanded version of the animation from \autoref{fig:gray-scott_movie_first_frame} containing several initial clusters of \textvar{B} particles. The same type of pattern is produced, albeit over a larger region.}
