...
\centering
\mySfFamily
\includegraphics[width = 0.7\textwidth]{../images/diffusion__Moment_1.png}
\caption{Phillip will fill in caption.}
...
\autoref{fig:gray-scott_movie_first_frame} shows an animation of the Gray-Scott model using the parameters  $f = 0.034$ and $k = 0.095$. We use the same initial configuration of the automaton that we used in the diffusion example, in which a cluster of \textvar{B} particles are found at the middle of a board full of \textvar{A} particles.\\

\begin{figure}[h]
\centering
\mySfFamily
\includegraphics[width = 0.7\textwidth]{../images/gs_f038_k100_Moment_1.png}
\caption{Phillip will fill in caption.}
...
\centering
\mySfFamily
\includegraphics[width = 0.7\textwidth]{../images/f038_100_multi_Moment_1.jpg}
\caption{Phillip will fill in caption.}
...
\centering
\mySfFamily
\includegraphics[width = 0.7\textwidth]{../images/f038_k102_multi_Moment_1.jpg}
\caption{Phillip will fill in caption.}
...
\centering
\mySfFamily
\includegraphics[width = 0.7\textwidth]{../images/f044_k102_multi_Moment_1.jpg}
\caption{Phillip will fill in caption.}
