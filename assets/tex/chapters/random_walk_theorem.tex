...
Let $\mathbf{x_i}$ denote the (random) vector corresponding to the particle's \textvar{i}-th step. The particle's position vector $\mathbf{x}$ after \textvar{n} steps is the sum of the $\mathbf{x_i}$,
