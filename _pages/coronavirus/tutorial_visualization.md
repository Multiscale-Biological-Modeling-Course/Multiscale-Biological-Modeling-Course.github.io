...
[![image-center](../assets/images/600px/Ridge4.png){: .align-center loading="lazy"}](../assets/images/Ridge4.png)
...
[![image-center](../assets/images/600px/Ridge5.png){: .align-center loading="lazy"}](../assets/images/Ridge5.png)
{: style="font-size: medium;"}

At this point, your `OpenGL Display` window should look like the following:

[![image-center](../assets/images/600px/Ridge6.png){: .align-center loading="lazy"}](../assets/images/Ridge6.png)
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/Ridge7.png){: .align-center loading="lazy"}](../assets/images/Ridge7.png)
{: style="font-size: medium;"}

You should now see two distinct colored structures!

[![image-center](../assets/images/600px/Ridge8.png){: .align-center loading="lazy"}](../assets/images/Ridge8.png)
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/Ridge8-1.png){: .align-center loading="lazy"}](../assets/images/Ridge8-1.png)
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/Ridge8-2.png){: .align-center loading="lazy"}](../assets/images/Ridge8-2.png)
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/Ridge9.png){: .align-center loading="lazy"}](../assets/images/Ridge9.png)
{: style="font-size: medium;"}

Your final visualization should look like the following figure.

[![image-center](../assets/images/600px/Ridge10.png){: .align-center loading="lazy"}](../assets/images/Ridge10.png)
{: style="font-size: medium;"}
