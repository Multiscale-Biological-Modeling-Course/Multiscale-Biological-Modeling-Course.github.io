...
The inner product is also useful for representing  giving the **mean-square fluctuation** of an alpha carbon, or the expected squared distance of node *i* from equilibrium. This value is given simply by the inner product $$  \Delta R_i, R_i $$ of a fluctuation vector with itself.
...
$$ C_{ij} = \frac{\Delta R_i \cdot \Delta R_j}{\left[ \Delta R_i \cdot \Delta R_i \Delta R_j \cdot \Delta R_j \right]^{\frac{1}{2}}} $$.
