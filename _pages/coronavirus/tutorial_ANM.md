...
[![image-center](../assets/images/600px/ANM1.png){: .align-center}]()
{: style="font-size: medium;"}

A small window will open. Select `ProDy Interface`.

[![image-center](../assets/images/600px/ANM2.png){: .align-center}]()
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/ANM3.png){: .align-center}]()
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/ANM4.png){: .align-center}]()
{: style="font-size: medium;"}

[![image-center](../assets/images/600px/ANM5.png){: .align-center}]()
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/ANM8.png){: .align-center}]()
{: style="font-size: medium;"}

`VMD Main` should now display a new row for the animation.

[![image-center](../assets/images/600px/ANM9.png){: .align-center}]()
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/ANM10.png){: .align-center}]()
{: style="font-size: medium;"}
