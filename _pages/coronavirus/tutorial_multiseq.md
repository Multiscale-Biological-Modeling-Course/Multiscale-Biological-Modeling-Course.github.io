...
excerpt: "Tutorial: use VMD's MultiSeq tool to align and compare SARS-CoV and SARS-CoV-2 spike protein structures, finding regions of local structural divergence."
sidebar:
 nav: "coronavirus"
toc: true
toc_sticky: true
