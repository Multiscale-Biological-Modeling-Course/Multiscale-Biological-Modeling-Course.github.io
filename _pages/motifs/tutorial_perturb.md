...
excerpt: "Tutorial: perturb the repressilator model parameters to test and quantify the robustness of biological oscillators in gene regulatory networks."
sidebar:
 nav: "motifs"
header:
...
[![image-center](../assets/images/600px/nfsim_new_project.png){: .align-center loading="lazy"}](../assets/images/nfsim_new_project.png)

Select `blank_file.bngl` and name your project `oscillators`.

[![image-center](../assets/images/600px/nfsim_new_file.png){: .align-center loading="lazy"}](../assets/images/nfsim_new_file.png)
