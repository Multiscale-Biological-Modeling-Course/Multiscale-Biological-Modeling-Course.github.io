...
[![image-center](../assets/images/600px/shalini_changed_nar.png){: .align-center}](../assets/images/shalini_changed_nar.png)
A plot of the concentration of Y particles over time across two simulations. In the first cell (yellow), we only have activation of *Y* by *X*, whereas in the second cell (blue), we keep all parameters fixed but add a reaction simulating the negative autoregulation of *Y*.
{: style="font-size: medium;"}
...
[![image-center](../assets/images/600px/shalini_changed_nar_equal_chart.png){: .align-center}](../assets/images/shalini_changed_nar_equal_chart.png)
