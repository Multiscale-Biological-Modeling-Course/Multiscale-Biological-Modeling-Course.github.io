...
[![Simulation output after first ligand addition](../assets/images/600px/tutorial_addition_vscode1.png){: .align-center loading="lazy"}](../assets/images/tutorial_addition_vscode1.png)

Open the newly created `addition.gdat` file and create a plot by clicking the `Built-in plotting` button.

[![Graph showing system response after ligand addition](../assets/images/600px/tutorial_addition_vscode2.png){: .align-center loading="lazy"}](../assets/images/tutorial_addition_vscode2.png)
